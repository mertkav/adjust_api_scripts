...
metrics = ["lifetime_value_iap_d0","lifetime_value_iap_d1","lifetime_value_iap_d2","lifetime_value_iap_d3",
           "lifetime_value_iap_d4","lifetime_value_iap_d5","lifetime_value_iap_d6","lifetime_value_iap_d7",
           "lifetime_value_iap_d8","lifetime_value_iap_d14","lifetime_value_iap_d30","lifetime_value_iap_d45",
           "lifetime_value_iap_d75"]
...
if response.status_code == 200 and response.text.strip():
    try:
        ...
        if "rows" in data and isinstance(data["rows"], list):
            ...
            filename = "adjust_ltv_iap_cumulative.csv"
