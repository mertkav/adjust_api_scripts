...
metrics = [
    "roas_d0", "roas_d1", "roas_d2", "roas_d3",
    "roas_d4", "roas_d5", "roas_d6", "roas_d7",
    "roas_d8", "roas_d14", "roas_d30", "roas_d45",
    "roas_d75", "roas_d90", "cohort_size_d0","cohort_size_d1","cohort_size_d2","cohort_size_d3",
           ...
           "cohort_size_d75", "cost"
]

# Dimensions
dimensions = ["day", "os_name", "country", "store_id", "app", "network", "campaign", "channel", "store_type"]
...
if response.status_code == 200 and response.text.strip():
    try:
        ...
        if "rows" in data and isinstance(data["rows"], list):
            ...
            filename = "adjust_roas_cumulative.csv"
