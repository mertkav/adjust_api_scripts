...
metrics = ["all_revenue_d0","all_revenue_d1","all_revenue_d2","all_revenue_d3",
           "all_revenue_d4","all_revenue_d5","all_revenue_d6","all_revenue_d7",
           "all_revenue_d8","all_revenue_d14","all_revenue_d30","all_revenue_d45",
           "all_revenue_d75"]
...
if response.status_code == 200 and response.text.strip():
    try:
        ...
        if "rows" in data and isinstance(data["rows"], list):
            ...
            # Convert all revenue metrics to float64
